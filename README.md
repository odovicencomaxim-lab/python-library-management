...
- ➕ **Aggiunta Libri**: Inserimento di titolo, autore e prezzo con controlli di validazione (es. prezzo non negativo).
- 🔍 **Ricerca**: Consultazione rapida dei dettagli di un singolo libro.
- 📋 **Visualizzazione Catalogo**: Elenco completo di tutti i libri presenti nel file JSON.
- 🔄 **Gestione Disponibilità**: Possibilità di cambiare lo stato del libro (Disponibile / Non disponibile).
